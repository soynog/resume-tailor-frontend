...
/***/ function(module, exports, __webpack_require__) {
	...
	var docsEvents = __webpack_require__(38);
...
/***/ function(module, exports) {
	...
	var app = {
	  ...
	  getDoc: function getDoc(id) {
	    return app.documents.find(function (doc) {
	      return doc.id === parseInt(id);
	    });
	  },
	  getVersion: function getVersion(docId, versId) {
	    return app.getDoc(docId).versions.find(function (v) {
	      return v.id === parseInt(versId);
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(4);
	var versionDisplay = __webpack_require__(6);
	var authDisplay = __webpack_require__(7);
	...
	var renderDocuments = function renderDocuments(documents) {
	  console.log("Rendering Documents");
	  console.log(documents);
	  var docListTemplate = __webpack_require__(28);
	  $('.content-container').append(docListTemplate({ documents: documents }));
	};
	...
	var renderNewDocForm = function renderNewDocForm() {
	  var newDocForm = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var docContJq = function docContJq(docId) {
	...
	var clearVersion = function clearVersion(docId) {
	  var doc = docContJq(docId);
	...
	var renderMaster = function renderMaster(docId) {
	  clearVersion(docId);
	...
	var renderVersion = function renderVersion(docId, versId) {
	  console.log("Rendering Version");

	  var vers = app.getVersion(docId, versId);
	  var tags = vers.tags.map(function (t) {
	    return t.section_id;
	  });
	  console.log(tags);
	...
	var renderActiveVersions = function renderActiveVersions() {
	...
	module.exports = {
	  renderActiveVersions: renderActiveVersions,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderAuthForms = function renderAuthForms() {
	  console.log("Rendering Auth Forms");
	  var userAuthTemplate = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"panel panel-doc doc-master-container\" data-doc-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + ">\n    <div class=\"panel-heading "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.json : depth0)) != null ? stack1.style : stack1), depth0))
	    + "\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(29),depth0,{"name":"doc-title-group","data":data,"indent":"      ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "    </div>\n    <div class=\"panel-body\" id=\"doc-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "-content\">  <!-- add class collapse to have it start collapsed-->\n      <div class=\"doc-version-container\" data-doc-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + ">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(30),depth0,{"name":"doc-version-tabs","data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "      </div>\n      <div class=\"doc-content-container\" data-parent-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " data-parent-type=\"Document\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(31),depth0,{"name":"doc-content","data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "      </div>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.documents : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"doc-title-group\" id=\"doc-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "-title\">\n  <!--<form class=\"edit-doc-title-form\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">-->\n    <span>\n      <button type=\"button\" class=\"btn btn-link expand-document-button\" data-toggle=\"collapse\" data-target=\"#doc-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "-content\" aria-expanded=\"false\" aria-controls=\"collapseExample\">\n        <span class=\"glyphicon glyphicon-menu-hamburger\" aria-hidden=\"true\"></span>\n      </button>\n    </span>\n    <div class=\"doc-title\">\n      <span contenteditable=\"false\" class=\"doc-title-input\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n        <h1>"
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "</h1>\n      </span>\n    </div>\n    <span>\n      <button type=\"button\" class=\"btn btn-link edit-doc-title-button\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n        <span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span>\n      </button>\n    </span>\n    <span>\n      <button type=\"button\" class=\"btn btn-link delete-document-button\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <li role=\"presentation\">\n        <a href=\"#ver-"
	    ...
	    + "\" aria-controls=\"ver-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" role=\"tab\" class=\"version-tab\" data-version-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n          <span contenteditable=\"true\" class=\"version-name-input\" data-version-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">"
	  ...
	  return "<!-- Version Tabs -->\n<div>\n  <ul class=\"nav nav-tabs\" role=\"tablist\">\n      <li role=\"presentation\" class=\"active\">\n        <a href=\"#master\" aria-controls=\"master\" role=\"tab\" class=\"master-tab\">\n          MASTER\n        </a>\n      </li>\n\n"
	    ...
	    + "\n      <li role=\"presentation\">\n        <a href=\"#ver-new\" aria-controls=\"ver-new\" role=\"tab\">\n          <span contenteditable=\"true\" class=\"new-version-input\">New Version</span>\n        </a>\n      </li>\n  </ul>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"doc-content-group level-"
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + "\" data-sect-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " data-level="
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + ">\n      <div class=\"doc-content level-"
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + "\">\n        <span contenteditable=\"true\" class=\"doc-content-input\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n          <div class=\"level-"
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + "\">"
	    + alias2(alias1((depth0 != null ? depth0.content : depth0), depth0))
	    + "</div>\n        </span>\n      </div>\n      <span>\n        <button type=\"button\" class=\"hide btn btn-link btn-xs add-tag-button\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n          <span class=\"glyphicon glyphicon-minus\" aria-hidden=\"true\"></span>\n        </button>\n      </span>\n      <span>\n        <button type=\"button\" class=\"hide btn btn-link btn-xs delete-tag-button\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n          <span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span>\n        </button>\n      </span>\n      <!-- Button for toggling new section collapse\n      <span>\n        <button type=\"button\" class=\"btn btn-link btn-sm toggle-new-content-button\" id=\"toggle-new-content-button-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" data-toggle=\"collapse\" data-target=\"#new-content-container-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.children : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    ...
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"new-content-container\" data-level="
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + ">\n  <!--<span contenteditable=\"true\" class=\"new-content-input\">\n    <div class=\""
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + "\"></div>\n  </span>-->\n  <input class=\"level-"
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + "-plus new-content-input\" placeholder=\"+\"></input>\n\n</div>\n";
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- New Document Field -->\n<!--<form id=\"new-doc-form\">\n  <div class=\"form-group new-doc-form col-xs-4\">\n    <input type=\"text\" name=\"title\" class=\"form-control\" placeholder=\"Create New Document\">\n    <button type=\"button\" class=\"btn btn-link create-document-button\" data-target=\""
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n      <span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span>\n    </button>\n  </div>\n</form>-->\n<div class=\"panel panel-doc\">\n  <div class=\"panel-heading\">\n    <div class=\"doc-title-group\">\n      <span>\n        <button type=\"button\" class=\"btn btn-link create-document-button\">\n          <span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span>\n        </button>\n      </span>\n      <div class=\"doc-title\">\n        <span contenteditable=\"true\" id=\"new-doc-title-input\">\n          <h1>New Document</h1>\n        </span>\n      </div>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(35);
	var authApi = __webpack_require__(36);
	var authUi = __webpack_require__(37);
	...
	var addHandlers = function addHandlers(signInCallback, signOutCallback) {
	  ...
	  $('#sign-up-form').on('submit', function (event) {
	    ...
	    console.log(data);
	    authApi.signUp(authApi.signIn(authUi.signUpSuccess, authUi.failure, data), authUi.failure, data);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var display = __webpack_require__(5);
	var docsApi = __webpack_require__(39);
	var docsUi = __webpack_require__(40);
	var sectEvents = __webpack_require__(41);
	var versEvents = __webpack_require__(44);
	var tagsEvents = __webpack_require__(47);

	var addNewDocHandler = function addNewDocHandler(callback) {
	  var createDocActions = function createDocActions(event) {
	    event.preventDefault();
	    console.log("New Doc Handler Clicked");
	    var title = $('#new-doc-title-input').text().trim();
	    console.log(title);
	...
	var addDeleteHandlers = function addDeleteHandlers(callback) {
	...
	var addEditTitleHandlers = function addEditTitleHandlers(callback) {
	  var toggleEditable = function toggleEditable(docId) {
	    var docTitleInput = $('.doc-title-input[data-target=' + docId + ']');
	  ...
	  $('.edit-doc-title-button').on('click', function (event) {
	    var docId = $(this).attr('data-target');
	...
	var addDocHandlers = function addDocHandlers(callback) {
	  return function () {
	...
	var getUserDocs = function getUserDocs() {
	  docsApi.getDocuments([docsUi.getDocsSuccess, display.refreshContent, addDocHandlers(getUserDocs), sectEvents.addSectHandlers(getUserDocs), versEvents.addVersHandlers(getUserDocs), tagsEvents.addTagHandlers(getUserDocs)], docsUi.failure);
	};

	module.exports = {
	  addDocHandlers: addDocHandlers,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDocuments = function getDocuments(success, failure) {
	  var url = app.api + '/documents';
	  $.ajax({
	    method: 'GET',
	    url: url,
	    headers: {
	...
	var createDocument = function createDocument(success, failure, title) {
	...
	var deleteDocument = function deleteDocument(success, failure, docId) {
	  console.log("Deleting Document");
	  var url = app.api + '/documents/' + docId;
	  $.ajax({
	    method: 'DELETE',
	    url: url,
	    headers: {
	...
	var updateDocTitle = function updateDocTitle(success, failure, docId, newTitle) {
	...
	var getDocContents = function getDocContents(success, failure, docId) {
	  var url = app.api + '/documents/' + docId;
	  $.ajax({
	    method: 'GET',
	    url: url,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createDocSuccess = function createDocSuccess(data) {
	  console.log("Document Created!");
	  console.log(data);
	};

	var deleteDocSuccess = function deleteDocSuccess() {
	  console.log("Document Deleted!");
	};

	var updateDocTitleSuccess = function updateDocTitleSuccess() {
	  console.log("Document Title Updated!");
	};

	var getDocsSuccess = function getDocsSuccess(data) {
	...
	module.exports = {
	  ...
	  deleteDocSuccess: deleteDocSuccess,
	  updateDocTitleSuccess: updateDocTitleSuccess,
	  getDocsSuccess: getDocsSuccess
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sectsApi = __webpack_require__(42);
	var sectsUi = __webpack_require__(43);
	...
	var addNewSectHandler = function addNewSectHandler(callback) {
	  $('.new-content-input').keydown(function (event) {
	    if (event.keyCode === 13) {
	      ...
	      console.log(level);
	      var container = $(this).closest($('.doc-content-container'));
	      var parentId = container.attr('data-parent-id');
	      var parentType = container.attr('data-parent-type');
	      var section = { content: content,
	        style: level,
	        parent_id: parentId,
	...
	var addSectionModHandlers = function addSectionModHandlers(callback) {
	  $('.doc-content-input').keydown(function (event) {
	    if (event.keyCode === 13) {
	      event.preventDefault();
	      console.log("Section Content Modification Entered");
	      var content = $(this).text().trim();
	      var container = $(this).closest($('.doc-content-input'));
	      var sectId = container.attr('data-target');
	      if (content) {
	...
	var addSectHandlers = function addSectHandlers(callback) {
	  return function () {
	...
	module.exports = {
	  addSectHandlers: addSectHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createSection = function createSection(success, failure, section) {
	  console.log("Creating Section");
	  var url = app.api + '/sections';
	  var data = {
	    section: section
	  };
	  console.log(data);
	...
	var deleteSection = function deleteSection(success, failure, sectId) {
	  console.log("Deleting Section");
	  var url = app.api + '/sections/' + sectId;
	  $.ajax({
	    method: 'DELETE',
	    url: url,
	    headers: {
	...
	var updateSection = function updateSection(success, failure, sectId, newContent) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createSectSuccess = function createSectSuccess(data) {
	  console.log("Section Created!");
	  console.log(data);
	};

	var deleteSectSuccess = function deleteSectSuccess() {
	  console.log("Section Deleted!");
	};

	var updateSectSuccess = function updateSectSuccess() {
	...
	module.exports = {
	  failure: failure,
	  createSectSuccess: createSectSuccess,
	  deleteSectSuccess: deleteSectSuccess,
	  updateSectSuccess: updateSectSuccess
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var versApi = __webpack_require__(45);
	var versUi = __webpack_require__(46);
	var app = __webpack_require__(4);
	var display = __webpack_require__(6);

	var addNewVersHandler = function addNewVersHandler(callback) {
	  $('.new-version-input').keydown(function (event) {
	    if (event.keyCode === 13) {
	      event.preventDefault();
	      console.log("New Version Requested");
	      var name = $(this).text().trim();
	      var container = $(this).closest($('.doc-version-container'));
	      var docId = container.attr('data-doc-id');
	      versApi.createVersion([versUi.createVersSuccess, callback], versUi.failure, name, docId);
	    }
	  });
	};

	var addVersionModHandlers = function addVersionModHandlers(callback) {
	  $('.version-name-input').keydown(function (event) {
	    if (event.keyCode === 13) {
	      event.preventDefault();
	      console.log("Version Modification Entered");
	      var content = $(this).text().trim();
	      var versId = $(this).attr('data-version-id');
	      console.log(content);
	      console.log(versId);
	      if (content) {
	...
	var setActiveVersion = function setActiveVersion(docId, versId) {
	  console.log("Setting Active Version");
	  app.activeVersions[docId] = versId ? parseInt(versId) : null;
	};

	var addVersDisplayHandlers = function addVersDisplayHandlers() {
	  // For Normal Versions
	  $('a.version-tab').on('click', function (event) {
	    event.preventDefault();
	    console.log("Version Display Requested");
	    var docId = $(this).closest('.doc-version-container').attr('data-doc-id');
	    var versId = $(this).attr('data-version-id');
	...
	var addVersHandlers = function addVersHandlers(callback) {
	  return function () {
	...
	module.exports = {
	  addVersHandlers: addVersHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createVersion = function createVersion(success, failure, name, docId) {
	  console.log("Creating Version");
	  var url = app.api + '/versions';
	  var data = {
	    version: {
	      name: name,
	      document_id: docId
	...
	var deleteVersion = function deleteVersion(success, failure, verId) {
	  console.log("Deleting Version");
	  var url = app.api + '/versions/' + verId;
	  $.ajax({
	    method: 'DELETE',
	    url: url,
	    headers: {
	...
	var updateVersion = function updateVersion(success, failure, versId, newName) {
	  console.log("Updating Version Name");
	  var url = app.api + '/versions/' + versId;
	  var data = {
	    version: {
	      name: newName
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createVersSuccess = function createVersSuccess(data) {
	  console.log("Version Created!");
	  console.log(data);
	};

	var deleteVersSuccess = function deleteVersSuccess() {
	  console.log("Version Deleted!");
	};

	var updateVersSuccess = function updateVersSuccess() {
	...
	module.exports = {
	  failure: failure,
	  createVersSuccess: createVersSuccess,
	  deleteVersSuccess: deleteVersSuccess,
	  updateVersSuccess: updateVersSuccess
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tagsApi = __webpack_require__(48);
	var tagsUi = __webpack_require__(49);
	var app = __webpack_require__(4);

	var getTagId = function getTagId(docId, versId, sectId) {
	  console.log("Getting Tag Id");
	  var tags = app.getVersion(docId, versId).tags;
	  var tagId = tags.find(function (t) {
	    return t.section_id === parseInt(sectId);
	  }).id;
	  console.log(tagId);
	  return tagId;
	};

	var addNewTagHandlers = function addNewTagHandlers(callback) {
	  $('.add-tag-button').on('click', function (event) {
	    event.preventDefault();
	    console.log("New Tag Requested");
	    var docId = $(this).closest($('.doc-master-container')).attr('data-doc-id');
	    var versId = app.activeVersions[docId];
	    var sectId = parseInt($(this).closest($('.doc-content-group')).attr('data-sect-id'));
	    console.log(versId);
	    console.log(sectId);
	...
	var addDelTagHandlers = function addDelTagHandlers(callback) {
	  $('.delete-tag-button').on('click', function (event) {
	    ...
	    var versId = app.activeVersions[docId];
	    var sectId = parseInt($(this).closest($('.doc-content-group')).attr('data-sect-id'));
	    var tagId = getTagId(docId, versId, sectId);
	    tagsApi.deleteTag([tagsUi.deleteTagSuccess, callback], tagsUi.failure, tagId);
	  });
	};

	var addTagHandlers = function addTagHandlers(callback) {
	  return function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createTag = function createTag(success, failure, versId, sectId) {
	  console.log("Creating Tag");
	  var url = app.api + '/tags';
	  var data = {
	    tag: {
	      version_id: versId,
	      section_id: sectId
	...
	var deleteTag = function deleteTag(success, failure, tagId) {
	  console.log("Deleting Tag");
	  var url = app.api + '/tags/' + tagId;
	  $.ajax({
	    method: 'DELETE',
	    url: url,
	    headers: {
...
/***/ function(module, exports) {
	...
	var createTagSuccess = function createTagSuccess(data) {
	  console.log("Tag Created!");
	  console.log(data);
	};

	var deleteTagSuccess = function deleteTagSuccess() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(35);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))

...
/***/ function(module, exports, __webpack_require__) {
	...
	var docsEvents = __webpack_require__(34);
	var sectEvents = __webpack_require__(127);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderDocuments = function renderDocuments(documents) {
	  ...
	  var docListTemplate = __webpack_require__(6);
	  $('.content-container').append(docListTemplate({ documents: documents }));
	};
	
	var renderNavBar = function renderNavBar(hide_navbar) {
	  if (hide_navbar) {
	...
	var renderModals = function renderModals(hide_modals) {
	  if (hide_modals) {
	    $('.modal-container').empty();
	  } else {
	    var modals = __webpack_require__(28);
	...
	var renderNewDocForm = function renderNewDocForm() {
	  ...
	  // }
	  var newDocForm = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"panel panel-doc\">\n    <div class=\"panel-heading "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.json : depth0)) != null ? stack1.style : stack1), depth0))
	    + "\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(125),depth0,{"name":"doc-title-group","data":data,"indent":"      ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "    </div>\n    <div class=\"collapse panel-body\" id=\"doc-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "-content\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(126),depth0,{"name":"doc-version-tabs","data":data,"indent":"      ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "      <div class=\"doc-content-container\" data-parent-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " data-parent-type=\"document\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(26),depth0,{"name":"doc-content","data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "      </div>\n    </div>\n  </div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"doc-content-row\">\n      <div class=\"doc-content\">\n        <span contenteditable=\"true\" class=\"doc-content-input\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n          <div class=\""
	    + alias2(alias1((depth0 != null ? depth0.style : depth0), depth0))
	    + "\">"
	    + alias2(alias1((depth0 != null ? depth0.content : depth0), depth0))
	    + "</div>\n        </span>\n      </div>\n      <span>\n        <button type=\"button\" class=\"btn btn-link btn-sm include-content-button\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n          <span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span>\n        </button>\n      </span>\n      <span>\n        <button type=\"button\" class=\"btn btn-link btn-sm remove-content-button\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.children : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    ...
	    + " small\">enter new content here</div>\n  </span>\n</div>\n";
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var authApi = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var docsApi = __webpack_require__(35);
	var docsUi = __webpack_require__(36);
	var sectEvents = __webpack_require__(127);
	...
	var addDocHandlers = function addDocHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteDocSuccess = function deleteDocSuccess(docId) {
	  console.log("Document Deleted!");
	
	  // Delete element from app.documents were id = id
	  console.log(docId);
	  app.documents.splice(app.documents.findIndex(function (doc) {
	    return doc.id === docId;
	  }), 1);
	  console.log(app);
	...
	var updateDocTitleSuccess = function updateDocTitleSuccess(docId, newTitle) {
	  console.log("Document Title Updated");
	  var docIndex = app.documents.findIndex(function (doc) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <li role=\"presentation\"><a href=\"#ver-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" aria-controls=\"ver-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	  ...
	  return "<!-- Version Tabs -->\n<div>\n\n  <!-- Nav tabs -->\n  <ul class=\"nav nav-tabs\" role=\"tablist\">\n      <li role=\"presentation\" class=\"active\"><a href=\"#master\" aria-controls=\"master\" role=\"tab\" data-toggle=\"tab\">MASTER</a></li>\n\n"
	    ...
	    + "\n      <li role=\"presentation\">\n        <span role=\"tab\" contenteditable=\"true\" id=\"new-ver-name-input\">New Version</span>\n        <span>\n          <button type=\"button\" class=\"btn btn-link btn-sm new-version-button\">\n            <span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span>\n          </button>\n        </span>\n      </li>\n  </ul>\n\n  <!-- Tab panes -->\n  <!--\n  <div class=\"tab-content\">\n    <div role=\"tabpanel\" class=\"tab-pane active\" id=\"home\"></div>\n    <div role=\"tabpanel\" class=\"tab-pane\" id=\"profile\"></div>\n    <div role=\"tabpanel\" class=\"tab-pane\" id=\"messages\"></div>\n    <div role=\"tabpanel\" class=\"tab-pane\" id=\"settings\"></div>\n  </div>\n  -->\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sectsApi = __webpack_require__(128);
	var sectsUi = __webpack_require__(129);
	...
	var addSectHandlers = function addSectHandlers() {
